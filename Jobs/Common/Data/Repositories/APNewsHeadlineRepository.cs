...
public class APNewsHeadlineRepository(NewsSnapshotDatabase database)
{
    public async Task CreateTableAsync()
    {
        string script = "CreateAPNewsHeadlineTableV1.1";
    ...
    public async Task<long> CreateAsync(APNewsHeadline headline, long jobId)
    {
        string commandText = @"
