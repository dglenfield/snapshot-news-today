...
{
    private static readonly LogLevel _applicationLogLevel = Configuration.LoggingSettings.ApplicationLogLevel;
    private static readonly string _logDirectory = Configuration.LoggingSettings.LogDirectory;
    private static readonly bool _logToConsole = Configuration.LoggingSettings.LogToConsole;
    private static readonly bool _logToFile = Configuration.LoggingSettings.LogToFile;
        ...
        [CallerLineNumber] int sourceLineNumber = 0)
    {
        ...
        if (_logToConsole || level == LogLevel.Error)
        {
